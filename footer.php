<section id="footer">
	...
	<div class="phone-icon">
		<a href="tel:+971547918858"> <img src="./images/phone-call.png" alt="phone"> </a>
	</div>
	<!-- Phone -->
	<!-- WhatsApp -->
	<div class="whatsapp-icon">
		<a href="https://api.whatsapp.com/send?phone=+971508993781&text=Hello YES Automation!." target="_blank">
	...
	<div id="back">
		<div class="container-fluid">
			<div class="col-md-7 col-sm-9">
				...
				<p>© 2025 <span>YesAutomation.ae</span> All rights reserved. Powered By <a href="https://bigleap.ae/"
						target="blank"><span>Big Leap</span></a></p>

			</div>

			<div class="col-md-5 col-sm-3">
				<a href="https://www.instagram.com/yes_automationuae/" target="blank" class="le"><i
						class="demo-icon icon-instagram">&#xe812;</i></a>
				<a class="le" target="blank" href="https://www.linkedin.com/company/yes-automation/"><i
						class="demo-icon icon-linkedin">&#xf0e1;</i></a>
				<a href="https://www.facebook.com/YES-Automation-109242957330326/" class="le" target="blank"><i
						class="demo-icon icon-003-facebook">&#xe808;</i></a>
